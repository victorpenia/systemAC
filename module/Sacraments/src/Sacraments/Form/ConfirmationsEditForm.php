...
class ConfirmationsEditForm extends Form {

    protected $dbadapter;
    protected $attestPriest;
    protected $baptismParish;

    public function __construct(AdapterInterface $dbAdapter, $attestPriest, $baptismParish) {
...
//            ),
//            'options' => array(
//                'empty_option' => 'Seleccione una parroquia',
//                'value_options' => $this->getOptionsForSelectParishesByConfirmation(),
//            )
//        ));
    ...
    public function getOptionsForSelectParishesByConfirmation()
    {
    ...
    {
        $dbAdapter = $this->dbadapter;
        $sql = "SELECT id, sacramentName, code, book FROM bookofsacraments where  sacramentName = 'Confirmaciones'";
        $statement = $dbAdapter->query($sql);
        $result = $statement->execute();
        $selectData = array();
        foreach ($result as $res) {
